...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Navbar */}
      <nav className="glass sticky top-0 z-50 transition-all duration-300 py-3">
        <div className="container mx-auto px-4 flex justify-between items-center">
          {/* Logo */}
          <Link href="/">
            <span className="font-bold text-2xl cursor-pointer text-gold">
              Lit³
            </span>
          </Link>
          ...
          <div className="hidden md:flex space-x-8">
            <Link href="/">
              <span className={`font-medium relative ${currentPage === 'home' ? 'nav-active' : 'hover:text-secondary-light transition-colors'}`}>
                Home
                {currentPage === 'home' && (
            ...
            <Link href="/services">
              <span className={`font-medium relative ${currentPage === 'services' ? 'nav-active' : 'hover:text-secondary-light transition-colors'}`}>
                Services
            ...
            <Link href="/portfolio">
              <span className={`font-medium relative ${currentPage === 'portfolio' ? 'nav-active' : 'hover:text-secondary-light transition-colors'}`}>
                Portfolio
            ...
            <Link href="/about">
              <span className={`font-medium relative ${currentPage === 'about' ? 'nav-active' : 'hover:text-secondary-light transition-colors'}`}>
                About
                {currentPage === 'about' && (
                  <span className="absolute bottom-0 left-0 w-full h-0.5 bg-secondary shine"></span>
                )}
            ...
            <Link href="/contact">
              <span className={`font-medium relative ${currentPage === 'contact' ? 'nav-active' : 'hover:text-secondary-light transition-colors'}`}>
                Contact
                {currentPage === 'contact' && (
                  <span className="absolute bottom-0 left-0 w-full h-0.5 bg-secondary shine"></span>
                )}
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <a href="https://www.instagram.com/thirdpowerlit/" className="text-gray-400 hover:text-gold transition-colors" aria-label="Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
